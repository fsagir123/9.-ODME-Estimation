...
#Reading layout
df=pd.read_csv('C:/Users/fsagir/Desktop/Work/10. Python & ML/2. Projects/11. ODME to Turning Volumes/LAYOUT.csv',skiprows = 2)
df.index = df['INTID']
...
df=pd.read_csv('C:/Users/fsagir/Desktop/Work/10. Python & ML/2. Projects/11. ODME to Turning Volumes/VOLUME.csv',skiprows = 3)
df.index = df['INTID']
df.fillna(0, inplace=True)
...
#origin 1
bounds[origin_name_to_number[1,2,0]] =  [35,35]
# # VISSIM [1,15,2]
# # OD code [1, 15, 2]
#bounds[origin_name_to_number[1,11,0]] =  [2,2]
# # VISSIM [1,15,17,20,11]
# # OD code [1,15,17,20,11]
#bounds[origin_name_to_number[1,12,0]] =  [6,6]
# VISSIM [1,15,17,20,12]
# OD code # VISSIM [1,15,17,20,12]
#bounds[origin_name_to_number[1,13,0]] =  [9,9]
# VISSIM [1,15,17,13]
# OD code [1, 15, 17, 13]

#origin 2
bounds[origin_name_to_number[2,1,0]] =  [21,21]
# VISSIM [2,15,1]
# OD code [2, 15, 1]

bounds[origin_name_to_number[2,11,0]] =  [23,23]
# VISSIM [2,15,17,20,11]
# OD code [2, 15, 17, 20, 11]

bounds[origin_name_to_number[2,12,0]] =  [58,58]
# VISSIM [2,15,17,20,12]
# OD code [2, 15, 17, 20, 12]

bounds[origin_name_to_number[2,13,0]] =  [88,88]
# VISSIM [2,15,17,13]
# OD code [2, 15, 17, 13]


#origin 3
#bounds[origin_name_to_number[3,5,0]] =  [3,3]
# VISSIM [3, 18, 14, 5]
# OD code [3, 18, 14, 5]

#bounds[origin_name_to_number[3,6,0]] =  [8,8]
# VISSIM [3,18,14,6]
# OD code [3, 18, 14, 6]


# bounds[origin_name_to_number[3,8,0]] =  [0,0]
#bounds[origin_name_to_number[3,9,0]] =  [5,5]
# VISSIM [3,18,14,16,9]
# OD code [3, 18, 14, 16, 9] 

#bounds[origin_name_to_number[3,10,0]] =  [0,0]
# VISSIM [3,18,14,5]
# OD code [3, 18, 14, 16, 19, 10]

#origin 4
#bounds[origin_name_to_number[4,3,0]] =  [1,1]
# VISSIM [4,14,18,3]
# OD code [4, 14, 18, 3]

bounds[origin_name_to_number[4,5,0]] =  [115,115]
# VISSIM [4,14,5]
# OD code [4, 14, 5]

bounds[origin_name_to_number[4,8,0]] =  [19,19]
# VISSIM [4,14,16,8]
# OD code [4, 14, 16, 8]

bounds[origin_name_to_number[4,10,0]] =  [21,21]
# VISSIM [4,14,16,19,10]
# OD code [4, 14, 16, 19, 10]

#origin 5
#bounds[origin_name_to_number[5,3,0]] =  [3,3]
# VISSIM [5,14,18,3]
# OD code 
bounds[origin_name_to_number[5,6,0]] =  [156,156]
# VISSIM [5,14,6]
# OD code [5, 14, 6]

# bounds[origin_name_to_number[5,8,0]] =  [0,0]
bounds[origin_name_to_number[5,9,0]] =  [179,179]
# VISSIM [5,14,16,9]
# OD code [5, 14, 16, 8]

#origin 7
#bounds[origin_name_to_number[7,3,0]] =  [5,5]
# VISSIM [7,16,14,18,3]
# OD code[7, 16, 14, 18, 3]
bounds[origin_name_to_number[7,5,0]] =  [90,90]
# VISSIM [7,16,14,5]
# OD code [7, 16, 14, 5]
bounds[origin_name_to_number[7,8,0]] =  [21,21]
# VISSIM [7,16,8]
# OD code [7, 16, 8]
bounds[origin_name_to_number[7,10,0]] =  [140,140]
# VISSIM [7,16,19,10]
# OD code [7, 16, 19, 10]

#origin 8
# bounds[origin_name_to_number[8,5,0]] =  [0,0]
bounds[origin_name_to_number[8,6,0]] =  [46,46]
# VISSIM [8,16,14,6]
# OD code [8, 16, 14, 6] 
bounds[origin_name_to_number[8,9,0]] =  [102,102]
# VISSIM [8,16,9]
# OD code 
bounds[origin_name_to_number[8,10,0]] =  [25,25]
# VISSIM [8,16,19,10]
# OD code [8, 16, 9]

#origin 10
# bounds[origin_name_to_number[10,5,0]] =  [0,0]
bounds[origin_name_to_number[10,6,0]] =  [58,58]
# VISSIM [10,19,16,14,6]
# OD code [10, 19, 16, 14, 6]
bounds[origin_name_to_number[10,8,0]] =  [64,64]
# VISSIM [10,19,16,8]
# OD code [10, 19, 16, 8]
bounds[origin_name_to_number[10,9,0]] =  [65,65]
# VISSIM [10,19,16,9]
# OD code [10, 19, 16, 9]

#origin 11
#bounds[origin_name_to_number[11,1,0]] =  [1,1]
# VISSIM [11,20,17,15,1]
# OD code [11, 20, 17, 15, 1]
#bounds[origin_name_to_number[11,2,0]] =  [13,13]
# VISSIM [11,20,17,15,2]
# OD code [11, 20, 17, 15, 2]
#bounds[origin_name_to_number[11,12,0]] =  [11,11]
# VISSIM [11,20,12]
# OD code [11, 20, 12]
#bounds[origin_name_to_number[11,13,0]] =  [13,13]
# VISSIM [11,20,17,13]
# OD code [11, 20, 17, 13]
 
#origin 12
#bounds[origin_name_to_number[12,1,0]] =  [5,5]
# VISSIM [12,20,17,15,1]
# OD code [12, 20, 17, 15, 1]]
bounds[origin_name_to_number[12,2,0]] =  [52,52]
# VISSIM [12,20,17,15,2]
# OD code [12, 20, 17, 15, 2]
bounds[origin_name_to_number[12,11,0]] =  [14,14]
# VISSIM [12,20,11]
# OD code [12, 20, 11]]
bounds[origin_name_to_number[12,13,0]] =  [53,53]
# VISSIM [12,20,17,13]
# OD code [12, 20, 17, 13]

#origin 13
#bounds[origin_name_to_number[13,1,0]] =  [4,4]
# VISSIM [13,17,15,1]
# OD code [13, 17, 15, 1]
bounds[origin_name_to_number[13,2,0]] =  [40,40]
# VISSIM [13,17,15,2]
# OD code [13, 17, 15, 2]
#bounds[origin_name_to_number[13,11,0]] =  [9,9]
# VISSIM [13,17,20,11]
# OD code[13, 17, 20, 11]
bounds[origin_name_to_number[13,12,0]] =  [23,23]
# VISSIM [13,17,20,12]
# OD code [13, 17, 20, 12]
...
for index, bound in enumerate(bounds):
    if bound[1]!=None:
        od_restricted_list.append(index)

bounds_original = deepcopy(bounds)
...
for bound in bounds:
    ...
    l_max = 45
    k_max = 10
    bounds =  deepcopy(bounds_original)

    for element in bounds:
        if element[0] > 0 :
            element[0]= element[0] - l
            if element[0]<0:
                element[0] = 0
        if element[1] != None:
            element[1] = element[1] + k
            
    bounds_intermediate =  deepcopy(bounds)

    for i in range(len(od_restricted_list)+1):
      for indices_list in list(itertools.combinations(od_restricted_list,i+1)):

        for index in indices_list:
            
            bounds = deepcopy(bounds_intermediate)
            if isinstance(bounds[index][1], int) and isinstance(bounds[index][0], int): 
                  bounds[index][0]= bounds[index][0] - l_max
                  if bounds[index][0]<0:
                      bounds[index][0] = 0
                  bounds[index][1] = bounds[index][1] + k_max
...
od_matrix.to_csv("Parent_OD_matrix.csv",float_format='%.0f')
